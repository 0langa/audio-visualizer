...
export const oscilloscope: PresetDef = {
  ...
  advanced: [
    { key: "traceAmp", label: "Trace height", min: 0.1, max: 0.5, step: 0.01, default: 0.34 },
    { key: "traceClamp", label: "Height limit", min: 0.2, max: 0.5, step: 0.01, default: 0.44 },
    { key: "coreWidth", label: "Core width", min: 0.001, max: 0.01, step: 0.0005, default: 0.0035 },
    { key: "agFloor", label: "Auto-gain floor", min: 0.1, max: 1, step: 0.05, default: 0.35 },
    { key: "agRange", label: "Auto-gain range", min: 0, max: 3, step: 0.1, default: 1.4 },
    { key: "hueWave", label: "Hue by wave", min: 0, max: 80, step: 1, default: 24 },
    { key: "ghostDim", label: "Mirror ghost", min: 0, max: 1, step: 0.05, default: 0.35 },
    { key: "fillDim", label: "Fill strength", min: 0, max: 0.5, step: 0.01, default: 0.16 },
    { key: "gridLevel", label: "Grid level", min: 0, max: 0.3, step: 0.01, default: 0.06 },
    { key: "scanline", label: "Scanlines", min: 0, max: 0.3, step: 0.01, default: 0.1 },
    { key: "beatLift", label: "Beat lift", min: 0, max: 0.5, step: 0.01, default: 0.1 },
    { key: "bgLevel", label: "Bg level", min: 0, max: 0.12, step: 0.004, default: 0.028 },
