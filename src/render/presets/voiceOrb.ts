...
export const voiceOrb: PresetDef = {
  ...
  advanced: [
    { key: "rmsBlend", label: "Instant blend", min: 0, max: 1, step: 0.02, default: 0.3 },
    { key: "growth", label: "Level growth", min: 0, max: 2, step: 0.05, default: 0.85 },
    { key: "idleBreath", label: "Idle breathing", min: 0, max: 0.05, step: 0.002, default: 0.012 },
    { key: "wobScale", label: "Wobble scale", min: 0, max: 0.08, step: 0.002, default: 0.03 },
    { key: "mode1", label: "Mode 3 amp", min: 0, max: 2, step: 0.05, default: 1 },
    { key: "mode2", label: "Mode 5 amp", min: 0, max: 2, step: 0.05, default: 0.7 },
    { key: "mode3", label: "Mode 8 amp", min: 0, max: 2, step: 0.05, default: 0.45 },
    { key: "coreGlow", label: "Core glow", min: 0, max: 0.6, step: 0.02, default: 0.18 },
    { key: "rimGlow", label: "Rim glow", min: 0, max: 1, step: 0.02, default: 0.3 },
    { key: "ringDist", label: "Ring distance", min: 1.1, max: 2.2, step: 0.05, default: 1.45 },
    { key: "ringWave", label: "Ring wave", min: 0, max: 0.12, step: 0.005, default: 0.045 },
    { key: "sparkleScale", label: "Sparkle scale", min: 10, max: 80, step: 2, default: 34 },
    { key: "bgLevel", label: "Bg level", min: 0, max: 0.12, step: 0.005, default: 0.035 },
    { key: "vignette", label: "Vignette", min: 0, max: 1, step: 0.05, default: 0.45 },
  ],
  wgsl: /* wgsl */ `
