...
- [ ] **Physical-key shortcuts (QWERTZ-safe).**
      TOOL-BLOCKED 2026-07-23: bundled Computer Use exposes character-key
...
- [❌] **Unsupported video-bg codec message.** FAIL 2026-07-23 on v2.44.1:
      selecting the MPEG-4 Part 2 fixture still showed `Could not load video
      background: Assertion failed.` instead of naming the codec problem and
      suggesting H.264/VP9. The H.264 fixture decoded and loaded without an
      error. Panel (G) → Scene tab →
...
- [❌] **Long-form export, flat memory.** FAIL 2026-07-23 on v2.44.1 before
      export: Beatform rejected the valid fixture with `Could not decode
      "long2h.mp3" (Unable to decode audio data)`. The bundled ffmpeg decoded
      the same file end-to-end and reported duration `02:00:00.00`, mono MP3
      at 44.1 kHz/128 kbps. A separate low-memory two-hour fixture at
      `D:\bf-test\media\long2h-lowrate.mp3` (8 kHz/24 kbps) failed with the
      same toast after a clean Beatform restart. Therefore no two-hour export
      or during-export memory samples were possible. Load `C:\bf-test\media\long2h.mp3`
